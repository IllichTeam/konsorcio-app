...
7. **Show the result.** Tell the user the file paths and a one-line thesis per variant. If a browser tool is available, screenshot each variant and include the images in the response.
